...
const routes: Routes = [
  ...
  {
    path: 'settings', component: AccountComponent, data: { title: 'Settings' }, canActivate: [AuthGuardLogin], children: [
      { path: 'profile', component: ProfileSettingsComponent, data: { title: 'Settings > Profile' }, canDeactivate: [LeaveGuard] },
      { path: 'account', component: AccountSettingsComponent, data: { title: 'Settings > Account' }, canDeactivate: [LeaveGuard] },
      { path: 'devices', component: DevicesSettingsComponent, data: { title: 'Settings > Devices' } },
      { path: '**', redirectTo: 'profile' }
    ]
  },
  {
    path: 'admin', component: AdminComponent, data: { title: 'Admin' }, canActivate: [AuthGuardAdmin], children: [
...
@NgModule({
  imports: [RouterModule.forRoot(routes, { useHash: false, anchorScrolling: 'enabled', scrollPositionRestoration: 'top' })],
